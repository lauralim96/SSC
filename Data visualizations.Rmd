...
#Boxplot
subset <- subset(df, (df$TRIAGECODE == 1 | df$TRIAGECODE == 2 | df$TRIAGECODE == 3 | df$TRIAGECODE == 4 | df$TRIAGECODE == 5 |
                        df$TRIAGECODE == 9) & (df$VISIT_LOS_MINUTES <= quantile(df$VISIT_LOS_MINUTES,0.95) ))
